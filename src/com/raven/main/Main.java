...
//        this.peerAddress = "localhost";
        ...
        MyPeer.getInstance().setPeerPort(peerPort);
    ...
    private void init() {
        ...
        lbUsername = new JLabel(peerName);
        lbUsername.setFont(new Font("Arial", Font.BOLD, 14));
        title.add(lbUsername, BorderLayout.WEST);
            ...
            public void saveImage(Icon image) {
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    try {
                        ...
                        System.out.println("Image saved successfully: " + fileToSave.getAbsolutePath());
                    } catch (IOException e) {
                        e.printStackTrace();
    ...
    private void initComponents() throws SocketException {
    ...
    public static void main(String args[]) {
        ...
        System.out.print("Nhập tên người dùng của bạn: ");
